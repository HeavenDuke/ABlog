...
!function(){var e=function(){$("#hshare").hshare({size:"large",renderText:!1,platforms:[{name:"qzone"},{name:"qq"},{name:"douban"},{name:"renren"},{name:"sinaweibo"},{name:"wechat"}],stat:{loadUrl:"/shares",updateUrl:"/shares"}})},n=function(){MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"],["\\(","\\)"]]}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub],function(){var e=$("#profile-content");e.html(marked(e.text())),$("pre code").each(function(){hljs.highlightBlock(this)})}),e()},t=function(){var e=$("#profile_content_input"),n=CodeMirror.fromTextArea(e[0],{value:e.val(),lineNumbers:!0,mode:"gfm",matchBrackets:!0,lineWrapping:!0,tabSize:4,theme:"monokai",keyMap:"sublime",extraKeys:{Enter:"newlineAndIndentContinueMarkdownList"},autoCloseBrackets:!0,smartIndent:!0,showCursorWhenSelecting:!0});$.richText(n),$("#profile_previewer_entry").on("click",function(){var t=($("#profile_previewer"),$("#profile_previewer_content"));n.save();var a=new marked.Renderer;a.image=function(e,n,t){var a='<img style="width: 100%;" src="'+e+'" alt="'+t+'"';return n&&(a+=' title="'+n+'"'),a+=this.options.xhtml?"/>":">"};var r=marked(e.val(),{renderer:a});t.html(r),MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"],["\\(","\\)"]]}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub]),t.children("pre").each(function(){hljs.highlightBlock(this)})})};$(document).on("ready",function(){null!=window.location.href.match(/\/profile\/edit/)?t():null!=window.location.href.match(/\/profile/)&&n()})}();