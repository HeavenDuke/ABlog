...
!function(){var n=[];MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"],["\\(","\\)"]]}});var e=new marked.Renderer;e.image=function(n,e,t){var a='<img class="md-image" style="max-height: 400px; max-width: 100%;" src="'+n+'" alt="'+t+'"';return e&&(a+=' title="'+e+'"'),a+=this.options.xhtml?"/>":">"};var t=function(){$("img.md-image").each(function(){$(this).parent().addClass("text-center")})},a=function(){var n=$("#column-introduction");MathJax.Hub.Queue(["Typeset",MathJax.Hub],function(){var a=marked(n.html(),{renderer:e});n.html(a),$("pre code").each(function(){hljs.highlightBlock(this)}),t()}),i()},i=function(){$("#hshare").hshare({size:"large",renderText:!1,platforms:[{name:"qzone"},{name:"qq"},{name:"douban"},{name:"renren"},{name:"sinaweibo"},{name:"wechat"}],stat:{loadUrl:"/shares",updateUrl:"/shares"}})},r=function(){var n=$("#column_content_input"),a=CodeMirror.fromTextArea(n[0],{value:n.val(),lineNumbers:!0,mode:"gfm",matchBrackets:!0,lineWrapping:!0,tabSize:4,theme:"monokai",keyMap:"sublime",extraKeys:{Enter:"newlineAndIndentContinueMarkdownList"},autoCloseBrackets:!0,smartIndent:!0,showCursorWhenSelecting:!0});$("#column_previewer_entry").on("click",function(){var i=($("#column_previewer"),$("#column_previewer_content"));a.save();var r=n.val();i.html(r),MathJax.Hub.Queue(["Typeset",MathJax.Hub],function(){r=marked(i.html(),{renderer:e}),i.html(r),i.children("pre").each(function(){hljs.highlightBlock(this)}),t()})}),$.richText(a)},l=function(){var e=$("#tags-container"),t=function(){e.empty(),e.append("<br>"),e.append("<span class='column-tag-divider'>关键词: "+(0==n.length?"暂无":"")+"</span>");for(var a=0;a<n.length;a++){e.append("<span class='column-tag'>"+n[a]+"</span>");var i=$("<a class='column-tag'>×</a>");i.click(function(){for(var e=0;e<n.length;e++)if(n[e]==$(this).prev().text().trim()){n.splice(e,1);break}$("input[name='tags']").val(JSON.stringify(n)),t()}),e.append(i),a<n.length-1&&e.append("<span class='column-tag-divider'> / </span>")}};$("#add-tag-entry").click(function(){var e=$("input[name='tag']"),a=e.val();!a||a.length>20||0==a.length?alert("标签字数控制在1~20个字符内"):n.includes(a)?alert("已添加当前标签"):(n.push(a),$("input[name='tags']").val(JSON.stringify(n)),t()),e.val("")}),e.children("span.column-tag").each(function(){"×"==$(this).text().trim()?$(this).click(function(){for(var e=0;e<n.length;e++)if(n[e]==$(this).prev().text().trim()){n.splice(e,1);break}$("input[name='tags']").val(JSON.stringify(n)),t()}):(n.push($(this).text().trim()),$("input[name='tags']").val(JSON.stringify(n)))})};$(document).on("ready",function(){null!=window.location.href.match(/\/columns\/\w+\/edit/)?(r(),l()):null!=window.location.href.match(/\/columns\/new/)?(r(),l()):null!=window.location.href.match(/\/columns\/\w+/)&&a()})}();